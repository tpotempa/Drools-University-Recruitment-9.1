...
public class UniversityMainVerySimple {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(UniversityMainVerySimple.class);
    ...
    public static void main(String[] args) {
        ...
        for (Candidate fact : uc) {
            ...
            KieSession kSession = kContainer.newKieSession("ksession-rules-verysimple");
