...
public class UniversityMainVirtuoso {

    private static final Logger LOGGER = LoggerFactory.getLogger(UniversityMainVirtuoso.class);
    ...
    public static void main(String[] args) {
        ...
        KieBase kBase = kContainer.getKieBase("virtuoso.nobligatory");
